  ...
  theme: {
    extend: {
      colors: {
        ...
        green: {
          50: '#f0faf2', 100: '#dcf4e2', 200: '#bbe8c7', 300: '#87d6a1',
          400: '#4dbb72', 500: '#27a04e', 600: '#1b813c', 700: '#186633',
          800: '#17522c', 900: '#144326', 950: '#0a2515',
        },
        gold: {
      ...
      boxShadow: {
        ...
        green: '0 4px 20px rgba(27,129,60,0.3)',
